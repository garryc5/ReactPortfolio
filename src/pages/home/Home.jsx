...
<iframe className={styles.linkedin} src="https://www.linkedin.com/embed/feed/update/urn:li:share:6588178652641452032" height="465" width="504" frameborder="0" allowfullscreen="" title="Embedded post"></iframe>
    ...
    <CodeSandBoxCard
        ...
        summery={<p>I made a Happy Birthday code sandbox for my firend David Bae.
        This neat little poc starts with one yellow ball randomly maving around the page. As you click more balls are added following the previous ball, spelling out Happy Birthday! link to original post: <a href="https://www.linkedin.com/posts/garrettcarver-software-engineer_hastyexternalplot-activity-6584153242010218496-nkkT">here</a>      Check out the code below.
        </p>}
